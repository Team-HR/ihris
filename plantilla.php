...
<div class="" :class="loader" id="app">
  ...
  <div class="ui fluid container" style="padding: 5px; margin: 5px;">
    <table id="plantilla_table" class="ui celled structured compact small table">
      <thead>
      ...
      <tbody id="tableContent">
        <tr id="loading_el">
          <td colspan="20" style="text-align: center; font-size: 32px; color: lightgrey; padding: 100px;">
            <!-- FETCHING DATA... -->
