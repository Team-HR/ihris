<?php $title = "LGU Sponsored Training"; require_once "header.php"; require_once "_connect.db.php";
$act_id = $_GET["act_id"];
?>
...
<script type="text/javascript">
	...
	function loadYear(){
		$.post('lgusponsoredtraining_proc.php', {
			...
			$("#loadYear").html(data);
			$("#print_title").html("LGU Sponsored Training "+data);
		});	
	}
...
<div class="ui container">
    ...
    <div class="left item" style="margin-right: 0px !important;">
      <button onclick="window.history.back();" class="blue ui icon button" title="Back" style="width: 65px;">
		...
		<div class="item">
			<!-- TITLE -->
			<h3><i class="icon book"></i> LGU Sponsored Training <span id="loadYear"></span></h3>
		</div>
		<div class="right item">
			<button class="ui icon mini green button" onclick="addNew('<?php echo $act_id;?>')"><i class="icon plus"></i>Add</button>
			<button class="ui icon blue mini button" onclick="print()" style="margin-right: 10px; width: 70px;"><i class="icon print"></i> Print
			</button>
		...
		<style type="text/css">
  		...
  		<table class="ui very compact celled structured small selectable table">
			<thead> 
				...
				<!-- <tfooter id="tableFooter"></tfooter> -->
			</table>
		</div>
	</div>
	<!-- content here end -->
