  ...
  <?php if ($auth->is_hr) { ?>
    ...
    <div id="reports_dropdown" class="ui pointing dropdown link item">
      ...
      <div class="menu">
        ...
        <a href="pds_completion_report.php" class="item"><i class="icon print"></i> PDS Filling Report</a>
      </div>
    </div>
    <div id="Leave_dropdown" class="ui pointing dropdown link item">
      ...
      <div class="menu">
        ...
        <a href="dtrSummary_yearly_report.php" class="item">DTR Yearly Report</a>
