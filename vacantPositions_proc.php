...
?>
	...
	<tr>
		...
		<td class="center aligned">
			<a class="ui mini icon basic button" title="Applicants' Profile" href="applicantsProfile.php?rspvac_id=<?=$rspvac_id?>"><i class="blue icon users"></i> Applicants' Profile</a>
		</td>
		<td><?=$position;?></td>
		<td><?=$sg;?></td>
		...
		<td class="center aligned" style="width: 195px;">
			<div class="ui mini icon basic buttons">
				<!-- onclick="openFunc('<?=$rspvac_id?>')" -->
			  <button class="ui button" title="Delete" onclick="editFunc('<?=$rspvac_id?>')"><i class="edit blue icon"></i> Edit</button>
			  <!-- <button class="ui button" title="Delete"><i class="trash icon"></i> </button> -->
			  <button class="ui button" title="Delete" onclick="deleteFunc('<?=$rspvac_id?>')"><i class="trash blue icon"></i> Delete</button>
			</div>
		</td>
	</tr>
