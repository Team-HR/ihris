<div id="pds_personal">
    <div id="form_pds_personal" class="ui tiny form">
        ...
        <a class="ui red ribbon label">Emergency Contact Details</a>
        <hr>
        <div class="three fields">
            <div class="field">
                <label>Name:</label>
                <input v-bind:class="{editState:!readonly,readOnly:readonly}" :readonly="readonly" v-model="employee.emergency_name" type="text" placeholder="--- N/A ---">
            </div>
            <div class="field">
                <label>Contact #:</label>
                <input v-bind:class="{editState:!readonly,readOnly:readonly}" :readonly="readonly" v-model="employee.emergency_number" type="text" placeholder="--- N/A ---">
            </div>
            <div class="field">
                <label>Address:</label>
                <input v-bind:class="{editState:!readonly,readOnly:readonly}" :readonly="readonly" v-model="employee.emergency_address" type="text" placeholder="--- N/A ---">
            </div>
        </div>
