                        ...
                        <div class="ui segment">
                            <form class="ui form" @submit.prevent="submitEntry()">
                                ...
                                <div class="field">
                                    ...
                                    <div v-for="(issue, i) in performance_issues_options" :key="i">
                                        <div class="ui checkbox" style="padding:2px">
                                            <input v-model="formData.performance_issues" type="checkbox" :value="issue"
                                ...
                                <div class="field">
                                    ...
                                    <input v-model="formData.others" type="text" name="others"
                                ...
                                <div class="field">
                                    ...
                                    <input v-model="formData.areas_of_improvement" type="text"
