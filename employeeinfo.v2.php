...
<div class="ui fluid container" style="min-height: 600px; padding: 5px;">
    <div class="ui borderless blue inverted mini menu">
        <div class="left item" style="margin-right: 0px !important;">
            <button onclick="window.history.back(); console.log(window.history);" class="blue ui icon button"
        ...
        <div class="right item">
            <button onclick="editModalFunc()" class="ui right floated blue button"
                style="padding: 10px 10px; font-size: 10px;"><i class="ui icon edit"></i> Edit</button>
        </div>
    </div>
            ...
            <div class="thirteen wide stretched column">
                ...
                <div class="ui tab active" data-tab="pds">
                    <div class="ui pointing secondary blue menu fluid" id="pds">
                        ...
                        <a class="item active" data-tab="work_experience">Work Experiences</a>
                    ...
                    <div class="ui tab segment active" data-tab="work_experience">
