...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#inputAddMeeting").dropdown();
    $("#editInputMeeting").dropdown();
...
function updateFunc(controlNumber){
  ...
  $.post('reqsandcoms_proc.php', {
    ...
    $("#editInputMeeting").dropdown("set selected",array.isMeeting);
  ...
  $("#editModal").modal({
    ...
    onApprove: function(){
      $.post('reqsandcoms_proc.php', {
        ...
        isMeeting: $("#editInputMeeting").val(),
        employeesArray: employeesArray,
        othersArray: othersArray,
      }, function(data, textStatus, xhr) {
        $(clear);
...
function removeOther(elementid){
  ...
  function loadViewRemarks(controlNumber){
    $.post('reqsandcoms_proc.php', {
      ...
      $("#date_view").html(array.dateFormatted);
  ...
  function clear(){
    ...
    $('.listAdded').empty();
    $('.listAddedEdit').empty();
    $("#inputAddMeeting").dropdown('clear');
...
<!-- open start -->
<div id="openModal" class="ui large modal">
    ...
    <div class="ui grid">
      <div class="six wide column">
        <table class="ui very basic table">
          ...
          <tr>
            <td><strong>Is Meeting?</strong></td>
      ...
      <div id="remarks_form" class="six wide column">
       <div class="" id="remarks_view_form">
        ...
        <button class="ui tiny basic button" onclick="editRemarks()" id="editRemarks">Edit</button>
      </div>
      <div class="ui form" id="remarks_edit_form" style="display: none;">
       ...
       <button class="ui tiny basic button" onclick="cancelRemarks()" id="cancelRemarks">Cancel</button>
          ...
          <div class="ui form">
            ...
            <div class="fields">
              ...
              <div class="three wide field">
                <label>Meeting ?:</label>
                <select id="inputAddMeeting" class="ui compact dropdown">
        ...
        <div class="eight wide column">
          <div class="ui form">
            ...
            <div class="fields">
              ...
              <div class="three wide field">
                <label>Meeting ?:</label>
                <select id="editInputMeeting" class="ui compact dropdown">
                  <option value="">Yes/No</option>
                  <option value="no">No</option>
                  <option value="yes">Yes</option>
                </select>
...
<div class="ui container" style="padding: 20px;">
  <table id="trTable" class="ui blue selectable very compact table" style="font-size: 12px;">
    <thead>
