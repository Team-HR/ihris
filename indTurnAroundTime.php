<?php $title = "Individual Turn Around Time";
...
<script type="text/javascript">
  ...
  function load(year) {
    $("#tableBody").load('indTurnAroundTime_proc.php', {
        load: true,
        yearState: year
      },
      function() {
  ...
  function addModalFunc() {
    ...
    $("#addNewForm").form({
      ...
      onSuccess: function(e) {
        ...
        $.post('indTurnAroundTime_proc.php', {
          addNew: true,
          data0: data[0],
          data1: data[1]
  ...
  function getValues(id) {
    ...
    $.ajax({
        url: 'indTurnAroundTime_proc.php',
        async: false,
        type: 'POST',
        dataType: 'json',
        data: {
...
<div class="ui containerA" style="padding-left: 20px; padding-right: 20px;">
  <div class="ui borderless blue inverted mini menu">
    ...
    <div class="item">
      <h3><i class="stopwatch icon"></i> Individual Turn Around Time</h3>
    </div>
  ...
  <div>
    ...
    <table id="trTable" class="ui blue selectable structured celled very compact table" style="font-size: 12px;">
      ...
      <tbody id="tableBody">
        <tr id="loading_el">
          <td colspan="11" style="text-align: center; font-size: 32px; color: lightgrey; padding: 100px;">
            <!-- FETCHING DATA... -->
