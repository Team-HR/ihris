  ...
  function addNew(){
      ...
      $('#registerForm').form({
        ...
        var usrdata = [
          ...
          $("#selTypeAdd").dropdown("restore defaults");
              console.log(data);
            } else if (data === "1") {
              console.log(data);
...
<h4 class="ui blue header"><i class="icon ban"></i> Denied Access:</h4>
<table id="" class="ui teal very compact small striped table">
  <thead>
    <tr>
      <th></th>
...
<div class="ui mini modal" id="modal_reqsOption">
  ...
  <form class="ui form" id="reqsForm" method="POST">
    ...
    <div class="field">
      ...
      <button class="ui mini basic red fluid button" type="button" id="reqsDeny"><i class="icon ban"></i> Deny</button>
    </div>
    <div class="ui error message"></div>
  </form>
