...
while ($row = $result->fetch_assoc()) {
  ...
  $sg = $row['sg'];
  $education = lister(unserialize($row['education']));
  $training = lister(unserialize($row['training']));
  $experience = lister(unserialize($row['experience']));
  $eligibility = lister(unserialize($row['eligibility']));
