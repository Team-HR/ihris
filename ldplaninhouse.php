<?php $title = "L&D Plan In-house Trainings";
      ...
      <table class="ui very compact celled structured small selectable table">
        <thead>
          <tr style="text-align: center;">
            ...
            <th class="headers noprint">Target Participants</th>
            <th class="headers"></th>
          ...
          <tr v-for="(item, index) in items" :key="index">
            ...
            <td class="right aligned noprint">
              <div class="ui mini basic icon buttons">
                ...
                <button class="ui button" title="Delete" @click="deleteRow(item.ldpinhousetrainings_id)"><i class="trash alternate outline icon"></i></button>
              </div>
            </td>
          </tr>
        </tbody>
...
<script src="./ldplaninhouse.js"></script>
<!-- delete modal end -->
