...
<script>
	$(document).ready(function() {
		$("#mulitipleFilters").dropdown({
			onChange: function (){
				$("#clearFilter").show();
				// get values of this drop
			// alert($(this).dropdown('get value'));
				$(load($(this).dropdown('get value')));
			},
		});
	...
	function load(filters){
			$.post('employeelist_proc.test.php', {
				load: true,
				filters: filters,
  ...
  <div class="actions">
    ...
    <div class="left item" style="margin-right: 0px !important;">
	  ...
	  <div class="right item">
	  	<button onclick="addModalFunc()" class="blue ui icon button" style="margin-right: 10px; width: 100px;" title="Add Personnel">
