  ...
  >
    ...
    <div class="five fields">
      ...
      <div class="field">
        ...
        <input
          :value="'Php '+formatNumber(parseInt(Plantilla['monthly_salary']))"
          readonly
        />
      </div>
      <div class="field">
        ...
        <input
          :value="'Php '+formatNumber(parseInt(Plantilla['monthly_salary']*12))"
          readonly
        />
      </div>
    </div>
    <div class="two fields">
      <div class="field">
        ...
        <input
          :value="Plantilla['vac_lastName']+' '+Plantilla['vac_firstName']+' '+Plantilla['vac_middleName']+' '+Plantilla['vac_extName']"
          readonly
        />
      </div>
      <div class="field">
    ...
    <div class="four fields">
      ...
      <div class="field">
        ...
        <select class="ui search dropdown" v-model="committee_chair">
          ...
          <option
            v-for="(comChair,index) in All_Employees"
            :value="comChair.employees_id"
          >
    ...
    <div class="four fields">
      ...
      <div class="field">
        ...
        <select class="ui search dropdown" v-model="HRMO">
          <option value="">Search Name</option>
          <option
            v-for="(hr,index) in All_Employees"
            :key="index"
            :value="hr.employees_id"
          >
