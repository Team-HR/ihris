		...
		$.post('employeelist.v2.ajax.php', {
			...
			if (array != null) {
				$("#editStat_drop").dropdown({
					showOnFocus: false,
				}).dropdown("set selected", array.status);
...
<div class="ui fluid container" style="padding: 5px;">
	...
	<div class="ui mini segment">
		<div class="ui multiple dropdown" id="mulitipleFilters" style="color: black;">
	...
	<table id="employees_table" class="ui small very compact celled selectable striped blue table" style="font-size: 12px;">
		...
		<tbody id="tableBody">
			<tr id="loading_el">
				<td colspan="10" style="text-align: center; font-size: 32px; color: lightgrey; padding: 100px;">
					<!-- FETCHING DATA... -->
