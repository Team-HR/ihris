var vue_prr = new Vue({
  ...
  methods: {
    ...
    get_items() {
      ...
      $.post(
        "performanceratingreportinfo_proc.v2.php",
        {
          load: true,
          prr_id: this.prr_id,
          type: this.type,
    ...
    ratingModal(prrlist_id, employees_id, prr_id) {
      $("#rating_modal").modal({ closable: false }).modal("show");
      $("#rating_modal").html(
        "<center><img style='transform: scale(0.1); margin-top: -200px;' src='assets/images/loading.gif'></center>"
      );
      $.post(
        "umbra/ratingAjaxForm.php",
        {
          prrList: prrlist_id,
          prr_id: prr_id,
          empId: employees_id,
      ...
      $.post(
        ...
        (data, textStatus, xhr) => {
          ...
          if (data == 1) {
            ...
            eventColor.srcElement.parentElement.parentElement.style.background =
              back;
          }
        }
      );
