        ...
        <div class="ui container borderless blue inverted mini menu">
            ...
            <div class="right item">
                <div class="ui right input">
                    <a href="casual_plantilla_print.php?plantilla_id=<?=$id?>" target="_blank"
                        class="ui icon mini green button" :class="{disabled:data.length>0?false:true}" style="margin-right: 5px;" title="Print"><i
