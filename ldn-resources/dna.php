<?php $title = "Development Needs Assessment";
...
<div class="ui container">
  <div class="ui borderless blue inverted mini menu noprint">
    ...
    <div class="item">
      <h3><i class="icon compass outline"></i> Development Needs Assessment</h3>
    </div>
  ...
  <div id="cons-tna-vue" class="ui bottom attached tab segment active" data-tab="cons">
    ...
    <h3 class="header">Consolidated List of Trainings and Target Participants based on TNA</h3>
      ...
      <table class="ui very compact celled structured table selectable striped">
        ...
        <tbody>
          <tr v-for="(item, index) in cons" :key="index">
            ...
            <!-- <td>
              ...
              <div class="ui accordion" style="margin: 0px; padding: 0px;">
                <div class="title" style="margin: 0px; padding: 0px;">
                  <i class="dropdown icon"></i>
                  Show Departments
                </div>
                <div class="content" style="margin: 0px; padding: 0px;">
                  <span v-for="(dept, d) in item.departments" :key="d">
                    {{d+1}}.) {{dept.department}} <br>
                  </span>    
                </div>
              </div>
